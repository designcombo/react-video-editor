...
export const Button: React.FC<{
  ...
  return (
    <Tag
      className={cn(
        'relative z-10 flex items-center justify-center rounded-full bg-black px-4 py-2 font-medium text-sm text-white transition duration-200 hover:bg-black/90 md:text-sm',
        variantClass,
        className
      )}
      {...props}
